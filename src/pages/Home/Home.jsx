...
export function NavBar() {
  ...
  return (
    <nav className="w-full h-[80px] flex items-center px-4 md:px-8 bg-white sticky top-0 z-50 relative">
      <div className="flex items-center w-[24%] min-w-[160px]">
        <a href="/">
          <img src={logo} className="lg:w-fit lg:h-12 w-[60vw]" alt="EduDash Logo" />
        </a>
      </div>
    ...
    <section className="relative z-10 overflow-hidden bg-gradient-to-b from-white to-primary-light/30" id="accueil">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:py-4 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        <div className="space-y-6 max-w-xl md:max-w-lg lg:max-w-xl text-center md:text-left mx-auto lg:mb-0 mb-12">
          <h1 className="lg:text-6xl lg:block hidden text-3xl font-display font-bold tracking-tight text-neutral-dark leading-tight">
            Gérez votre école <br />
            <span className="bg-clip-text text-neutral-dark bg-gradient-to-r from-primary-dark to-orange-500">
              simplement et efficacement
            </span>
          </h1>

          <p className="text-base lg:text-lg text-sm text-neutral-gray max-w-xl mx-auto leading-relaxed">
          ...
          <div className="lg:flex hidden flex-col sm:flex-row gap-4 pt-4 items-start sm:items-center">
            <a href="/login">
              <button className="px-10 py-3 text-lg rounded-xl bg-[#FFAA27] text-white font-medium hover:bg-primary-dark/90 transition-all shadow-lg hover:shadow-xl duration-300 flex items-center justify-center">
                Se Connecter
              </button>
            </a>
            <a href="#contact">
          ...
          <div className="lg:hidden flex justify-center">
            <a href="/login" className="flex py-3 px-6 rounded-lg bg-[#FFAA27] text-white font-semibold text-base shadow-md hover:bg-orange-500 transition">
              Se connecter
            </a>
          </div>
        </div>
      ...
      <div className="lg:block hidden relative lg:pt-3 pt-6 lg:py-8 lg:px-6 md:px-12 lg:px-24 bg-white/70 backdrop-blur-sm border-t border-gray-100">
        <div className="max-w-7xl mx-auto">
          <p className="text-center text-sm uppercase tracking-wider text-gray-500 font-medium mb-8">Déjà adopté par des établissements reconnus</p>
        </div>
      </div>
    </section>
  );
...
export function PourquoiEduDash() {
  const points = [
    {
      icon: <Layers className="w-6 h-6 text-[#FFAA27]" />,
    ...
    {
      icon: <BarChart3 className="w-6 h-6 text-[#FFAA27]" />,
    ...
    {
      icon: <MessageSquare className="w-6 h-6 text-[#FFAA27]" />,
    ...
    {
      icon: <Shield className="w-6 h-6 text-[#FFAA27]" />,
    ...
    {
      icon: <FileDown className="w-6 h-6 text-[#FFAA27]" />,
    ...
    {
      icon: <Globe2 className="w-6 h-6 text-[#FFAA27]" />,
...
export function FeaturesSection() {
  ...
  const features = [
    {
      icon: <Users2 className="w-6 h-6 text-[#FFAA27]" />,
    ...
    {
      icon: <MessageCircle className="w-6 h-6 text-[#FFAA27]" />,
    ...
    {
      icon: <CreditCard className="w-6 h-6 text-[#FFAA27]" />,
    ...
    {
      icon: <FileBarChart className="w-6 h-6 text-[#FFAA27]" />,
    ...
    {
      icon: <CalendarDays className="w-6 h-6 text-[#FFAA27]" />,
    ...
    {
      icon: <Bell className="w-6 h-6 text-[#FFAA27]" />,
  ...
  return (
    <section id="fonctionnalites" className="bg-gradient-to-b from-white to-orange-50 py-20 lg:block hidden">
      <div className="max-w-5xl mx-auto px-6 md:px-10">
        <div className="text-center mb-16">
          <h2 className="lg:text-4xl text-2xl font-bold text-gray-900 mb-3">Les <span>Fonctionnalités Clés</span></h2>
          <p className="text-gray-600 max-w-2xl mx-auto lg:text-lg text-sm">EDU Dash combine puissance et simplicité pour transformer la gestion scolaire en une expérience fluide et moderne.</p>
        </div>

        <div className="divide-y divide-gray-100 bg-white rounded-2xl shadow-sm overflow-hidden">
          {features.map((feature, index) => (
            <div key={index} className="group transition-all duration-300 hover:bg-orange-50/40">
              <button onClick={() => toggle(index)} className="w-full cursor-pointer flex items-center justify-between px-6 py-5 text-left focus:outline-none">
                <div className="flex items-center gap-4">
                  <div className="bg-[#FFAA27]/10 p-3 rounded-xl">{feature.icon}</div>
                  <h3 className="text-lg font-semibold text-gray-800">{feature.title}</h3>
                </div>
                <ChevronDown className={`text-[#FFAA27] w-5 h-5 transform transition-transform duration-300 ${openIndex === index ? "rotate-180" : ""}`} />
              </button>
...
export function StatistiquesHome() {
  ...
  const stats = [
    { end: 7500, suffix: "+", label: "Étudiants Inscrits", icon: <GraduationCap className="w-8 h-8 text-[#FFAA27]" /> },
    { end: 150, suffix: "+", label: "Enseignants Actifs", icon: <Users className="w-8 h-8 text-[#FFAA27]" /> },
    { end: 8020, suffix: "+", label: "Parents Connectés", icon: <Smile className="w-8 h-8 text-[#FFAA27]" /> },
    { end: 430, suffix: "+", label: "Équipe Administrative", icon: <Building2 className="w-8 h-8 text-[#FFAA27]" /> },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((s, i) => (
            <div
              key={i}
              className={`bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-2 transform transition-all duration-500 border border-orange-100 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
              style={{ transitionDelay: `${i * 150}ms` }}
            >
              <div className="flex flex-col items-center text-center">
                <div className="bg-[#FFAA27]/10 p-4 rounded-full mb-4">{s.icon}</div>
                <h3 className="text-4xl font-semibold text-[#FFAA27] mb-1">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {testimonials.map((t, i) => (
            <div key={i} className="relative bg-white p-8 rounded-3xl shadow-md border border-gray-100 hover:shadow-lg transition-all duration-300 text-left group">
              ...
              <div className="mt-8">
                <h4 className="font-semibold text-[#FFAA27]">{t.name}</h4>
                <p className="text-sm text-gray-500 mb-4">{t.role}</p>
                <p className="italic text-gray-700 leading-relaxed">“{t.quote}”</p>
              </div>

              <div className="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-[#FFAA27]/30 transition-all duration-300"></div>
            </div>
          ))}
        </div>
      </div>
          ...
          <div className="hidden md:flex lg:flex-1 p-8 flex-col">
            ...
            <ul className="space-y-6 text-gray-700">
              <li className="flex items-start gap-4">
                <div className="bg-[#FFAA27]/10 text-[#FFAA27] p-3 rounded-full"><Mail size={20} /></div>
                <div><p className="font-semibold">E-mail</p><p className="text-gray-600">edudashma@gmail.com</p></div>
              </li>
              <li className="flex items-start gap-4">
                <div className="bg-[#FFAA27]/10 text-[#FFAA27] p-3 rounded-full"><MapPin size={20} /></div>
                <div><p className="font-semibold">Adresse</p><p className="text-gray-600">Casablanca, Maroc</p></div>
              </li>
              <li className="flex items-start gap-4">
                <div className="bg-[#FFAA27]/10 text-[#FFAA27] p-3 rounded-full"><Clock size={20} /></div>
                <div><p className="font-semibold">Horaires</p><p className="text-gray-600">Lun - Ven : 9h à 18h</p></div>
              </li>
            </ul>

            <div className="mt-10 border-t border-gray-100 pt-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Besoin d’aide rapide ?</h4>
              <p className="text-gray-600 text-sm mb-4">Vous pouvez également consulter notre centre d’aide ou contacter un responsable de votre établissement pour un accompagnement direct.</p>
            </div>
          </div>

          {/* Right: Contact Form */}
          <div className="flex-[1.3] bg-white px-4 lg:p-8 lg:space-y-6">
            <form onSubmit={handleContactSubmit} className="space-y-6">
              <div>
                <label className="block text-gray-800 text-sm font-medium mb-2">Votre nom</label>
                <div className="relative">
                  <User size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
                  <input name="name" value={contact.name} onChange={handleContactChange} placeholder="Jean Dupont" required
                    className="w-full pl-10 pr-3 py-3 rounded-xl border border-gray-200 bg-white placeholder-gray-400 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-[#FFAA27]/40 focus:border-[#FFAA27] transition" />
                </div>
              </div>

              <div>
                <label className="block text-gray-800 text-sm font-medium mb-2">E-mail</label>
                <div className="relative">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea name="message" value={contact.message} onChange={handleContactChange} rows={5} placeholder="Votre message..." required
                    className="w-full pl-10 pr-3 py-3 rounded-xl border border-gray-200 bg-white placeholder-gray-400 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-[#FFAA27]/40 focus:border-[#FFAA27] transition resize-none" />
                </div>
              </div>
            ...
            {status === "error" && <p className="text-red-500 text-sm mt-2 bg-red-50 border border-red-100 p-2 rounded-lg">{errorMessage}</p>}
            {status === "success" && <p className="text-green-600 text-sm mt-2 bg-green-50 border border-green-100 p-2 rounded-lg">Merci ! Votre message a été envoyé avec succès.</p>}
          </div>
        </div>
      </div>
    </section>
...
export function FinalCTA() {
  return (
    <section className="relative lg:block hidden py-20">
      <div className="max-w-5xl mx-auto px-6 text-center space-y-8">
        <h2 className="lg:text-5xl text-4xl font-bold leading-tight">Prêt à moderniser la gestion de votre école ?</h2>
        <p className="text-md lg:text-xl max-w-2xl mx-auto">Rejoignez les établissements qui font déjà confiance à EDU Dash et découvrez une nouvelle façon de gérer votre école, simplement et efficacement.</p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          <a href="/login" className="px-8 py-3 rounded-xl text-white bg-[#FFAA27] hover:text-[#FFAA27] hover:bg-white transition-colors duration-300 border hover:border-[#FFAA27] font-semibold hover:bg-gray-100 transition shadow-lg">Se connecter</a>
          <a href="#contact" className="px-8 py-3 rounded-xl bg-gray-50 text-black hover:bg-gray-900 hover:text-white transition-colors duration-300 border-2 border-white font-semibold">Nous contacter</a>
        </div>
      </div>
    </section>
  );
    ...
    <footer className="bg-white text-black py-16 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between gap-12">
        <div className="flex-1 md:flex-none">
          <img src={logo} alt="EduDash Logo" className="h-12 mb-4" />
          <p className="text-sm text-gray-600 leading-relaxed max-w-sm">EduDash est une plateforme de gestion scolaire intuitive et complète pour moderniser la vie éducative.</p>
        </div>
        ...
        <div className="flex-1">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">Newsletter</h3>
          <form className="flex flex-col sm:flex-row gap-2">
            <input type="email" placeholder="Votre email" className="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#FFAA27]" />
            <button type="submit" className="px-4 py-2 rounded-md bg-[#FFAA27] text-white font-medium hover:bg-primary-dark transition-colors">S'inscrire</button>
          </form>
        </div>
      </div>

      <div className="mt-12 border-t border-gray-100 pt-6 text-center text-sm text-gray-500">© {new Date().getFullYear()} EduDash. Tous droits réservés.</div>
    </footer>
  );
}
