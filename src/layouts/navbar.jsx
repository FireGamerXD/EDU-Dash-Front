    ...
    return (
        <nav className="w-full h-[80px] flex items-center px-4 md:px-8 bg-white sticky top-0 z-50">
            ...
            <div className="hidden md:flex flex-1 justify-center gap-8 text-md">
                ...
                <a href="/soon" className="text-gray-700 hover:text-[#ffa500] transition-colors duration-200 relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:h-[2px] after:w-0 after:bg-[#ffa500] after:transition-all after:duration-300 hover:after:w-full">Démo</a>
